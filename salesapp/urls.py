...
from .views import billfunc, taxfunc, SalesCreate,SalesDetail, HomeClass, SalesDelete, SalesUpdate, SaleList
...
urlpatterns = [
    ...
    path('detail/<int:pk>', SalesDetail.as_view(), name='detail'),
